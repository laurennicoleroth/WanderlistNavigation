//
//  MultiHitsTableViewController.swift
//  InstantSearch-iOS
//
...
/// This class gives you the boilerplate needed to have a multi hits view linked to InstantSearch.
    ...
    public var hitsTableViews: [MultiHitsTableWidget] = [] {
        didSet {
            for hitsTableView in hitsTableViews {
                let hitsController = MultiHitsController(table: hitsTableView)
